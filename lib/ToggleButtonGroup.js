...
var ToggleButtonGroup = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.getValues = function getValues() {
    ...
    return value == null ? [] : (0, _concat["default"])(_context = []).call(_context, value);
  };
  ...
  _proto.handleToggle = function handleToggle(value) {
    ...
    var isActive = (0, _indexOf["default"])(values).call(values, value) !== -1;
    ...
    if (isActive) {
      onChange((0, _filter["default"])(values).call(values, function (n) {
        return n !== value;
      }));
    } else {
      var _context2;

      onChange((0, _concat["default"])(_context2 = []).call(_context2, values, [value]));
    }
  };
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/_react["default"].createElement(_ButtonGroup["default"], (0, _extends2["default"])({}, props, {
      "data-toggle": "buttons"
      ...
      return /*#__PURE__*/_react["default"].cloneElement(child, {
        ...
        checked: (0, _indexOf["default"])(values).call(values, value) !== -1,
