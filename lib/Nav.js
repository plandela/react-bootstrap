...
var Nav = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.componentDidUpdate = function componentDidUpdate() {
    ...
    var activeChild = (0, _find["default"])(_ValidComponentChildren["default"]).call(_ValidComponentChildren["default"], children, function (child) {
      return _this.isActive(child, activeKey, activeHref);
    });

    var childrenArray = _ValidComponentChildren["default"].toArray(children);

    var activeChildIndex = (0, _indexOf["default"])(childrenArray).call(childrenArray, activeChild);
  ...
  _proto.getNextActiveChild = function getNextActiveChild(offset) {
    ...
    var children = this.props.children;
    var validChildren = (0, _filter["default"])(_ValidComponentChildren["default"]).call(_ValidComponentChildren["default"], children, function (child) {
    ...
    var activeChildIndex = (0, _indexOf["default"])(validChildren).call(validChildren, activeChild);
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/_react["default"].createElement("ul", (0, _extends3["default"])({}, elementProps, {
      role: role,
      ...
      return /*#__PURE__*/(0, _react.cloneElement)(child, (0, _extends3["default"])({}, _this4.getTabProps(child, tabContainer, role, active, childOnSelect), {
        active: active,
        activeKey: activeKey,
