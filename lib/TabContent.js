...
var TabContent = /*#__PURE__*/function (_React$Component) {
  ...
  function TabContent(props, context) {
    ...
    _this.handlePaneEnter = (0, _bind["default"])(_context = _this.handlePaneEnter).call(_context, (0, _assertThisInitialized2["default"])(_this));
    _this.handlePaneExited = (0, _bind["default"])(_context2 = _this.handlePaneExited).call(_context2, (0, _assertThisInitialized2["default"])(_this)); // Active entries in state will be `null` unless `animation` is set. Need
