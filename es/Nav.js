...
var Nav = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.componentDidUpdate = function componentDidUpdate() {
    ...
    var activeChild = _findInstanceProperty(ValidComponentChildren).call(ValidComponentChildren, children, function (child) {
      return _this.isActive(child, activeKey, activeHref);
    });

    var childrenArray = ValidComponentChildren.toArray(children);

    var activeChildIndex = _indexOfInstanceProperty(childrenArray).call(childrenArray, activeChild);
  ...
  _proto.getNextActiveChild = function getNextActiveChild(offset) {
    ...
    var validChildren = _filterInstanceProperty(ValidComponentChildren).call(ValidComponentChildren, children, function (child) {
    ...
    var activeChildIndex = _indexOfInstanceProperty(validChildren).call(validChildren, activeChild);
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement("ul", _extends({}, elementProps, {
      ...
      return /*#__PURE__*/cloneElement(child, _extends({}, _this4.getTabProps(child, tabContainer, role, active, childOnSelect), {
        active: active,
        activeKey: activeKey,
