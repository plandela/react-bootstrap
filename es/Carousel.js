...
var Carousel = /*#__PURE__*/function (_React$Component) {
  ...
  function Carousel(props, context) {
    ...
    _this.handlePrev = _bindInstanceProperty(_context3 = _this.handlePrev).call(_context3, _assertThisInitialized(_this));
    _this.handleNext = _bindInstanceProperty(_context4 = _this.handleNext).call(_context4, _assertThisInitialized(_this));
    _this.handleItemAnimateOutEnd = _bindInstanceProperty(_context5 = _this.handleItemAnimateOutEnd).call(_context5, _assertThisInitialized(_this));
  ...
  _proto.render = function render() {
    ...
    }, _mapInstanceProperty(ValidComponentChildren).call(ValidComponentChildren, children, function (child, index) {
