...
var DropdownMenu = /*#__PURE__*/function (_React$Component) {
  ...
  function DropdownMenu(props) {
    ...
    _this.handleRootClose = _bindInstanceProperty(_context = _this.handleRootClose).call(_context, _assertThisInitialized(_this));
    _this.handleKeyDown = _bindInstanceProperty(_context2 = _this.handleKeyDown).call(_context2, _assertThisInitialized(_this));
    return _this;
  }
  ...
  _proto.getItemsAndActiveIndex = function getItemsAndActiveIndex() {
    ...
    var activeIndex = _indexOfInstanceProperty(items).call(items, document.activeElement);
