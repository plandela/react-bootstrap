...
var TabContent = /*#__PURE__*/function (_React$Component) {
  ...
  function TabContent(props, context) {
    ...
    _this.handlePaneEnter = _bindInstanceProperty(_context = _this.handlePaneEnter).call(_context, _assertThisInitialized(_this));
    _this.handlePaneExited = _bindInstanceProperty(_context2 = _this.handlePaneExited).call(_context2, _assertThisInitialized(_this)); // Active entries in state will be `null` unless `animation` is set. Need
